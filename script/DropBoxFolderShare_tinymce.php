        ...
        <form id="superbutton_form" action="#">
            ...
            <div id="content1">
              ...
              <table border="0" cellpadding="4" cellspacing="0">
                <tr>
                  ...
                  <td><input id="txt_link" name="txt_link" type="text" class="mceFocus" value="http://" style="width: 250px" onFocus="try{this.select();}catch(e){}" /></td>
                </tr>
                <tr>
                  <td colspan="2" style="text-align: center;"><input <?php echo $desactivados; ?> id="rbt_ver_como" name="rbt_ver_como" type="radio" value="lista" <?php echo $visible_content_sel; ?> />
                    {#DropBoxFolderShare.txt_ver_como_lista}&nbsp;
                    <input <?php echo $show_as_list; ?> id="rbt_ver_como" name="rbt_ver_como" type="radio" value="iconos" <?php echo $show_as_icons; ?> />
          ...
          <div class="mceActionPanel">
            ...
            <div style="float: right">
              <input type="button" id="insert" name="insert" value="{#insert}" onClick="insertarContenido(); alert('hola');" />
            </div>
          </div>
        </form>
</body>
