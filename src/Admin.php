...
class Admin extends Principal
{
    ...
    function pagAdmin()
    {
        $this->plugin_screen_hook_suffix = add_options_page(
            ...
            '<img width="17px" src="'. DROPBOX_FOLDER_SHARE_PLUGIN_URL .'/src/img/HT-Works.png" alt="" /> Dropbox Folder Share', // Titulo Menu
            parent::_PERMISOS_REQUERIDOS_, //Permisos Necesarios
            DROPBOX_FOLDER_SHARE_PLUGIN_NOMBRE, //id Unico del Menu
    ...
    {
        require_once(DROPBOX_FOLDER_SHARE_PLUGIN_PATH . 'src/Admin/admin_page.php');
    }
    ...
    function plugin_admin_init()
    {
        ...
        foreach ($secciones as $indice => $contenido) {
            add_settings_section(
                ...
                DROPBOX_FOLDER_SHARE_PLUGIN_NOMBRE                         // page menu_slug para ser usado en do_settings_sections()
            );
            foreach ($contenido['campos'] as $idxCampo => $tituloCampo) {
                add_settings_field(
                    ...
                    DROPBOX_FOLDER_SHARE_PLUGIN_NOMBRE,                                //pagina de menu que mostrara este campo (do_settings_sections())
    ...
    public function enqueue_admin_scripts() {
        ...
        if ($this->plugin_screen_hook_suffix == $screen->id) {
            //wp_enqueue_media();
            wp_enqueue_script('DFS-Script', DROPBOX_FOLDER_SHARE_PLUGIN_URL . 'src/js/scripts-admin.js', array('jquery'));
            /*
